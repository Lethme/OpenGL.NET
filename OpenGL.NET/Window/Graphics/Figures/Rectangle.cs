...
namespace OpenGL.Window.Graphics.Figures
{
    public class Rectangle : Figure
    {
        ...
        public Rectangle
        (
            float x1 = 0f, float y1 = 0f,
            float x2 = 0f, float y2 = 0f,
            float x3 = 0f, float y3 = 0f,
            float x4 = 0f, float y4 = 0f,
            FloatColor fillColor = null,
            FloatColor borderColor = null
        )
        {
            ...
            if (fillColor == null) this.FillColor = FloatColor.DefaultColor;
            else this.FillColor = fillColor;

            if (borderColor == null) this.BorderColor = FloatColor.DefaultColor;
        ...
        )
        {
            ...
            if (fillColor == null) this.FillColor = FloatColor.DefaultColor;
            else this.FillColor = FloatColor.Create(fillColor);

            if (borderColor == null) this.BorderColor = FloatColor.DefaultColor;
            else this.BorderColor = FloatColor.Create(borderColor);
        }
        ...
        public static Rectangle Create(float x1 = 0f, float y1 = 0f, float x2 = 0f, float y2 = 0f, float x3 = 0f, float y3 = 0f, float x4 = 0f, float y4 = 0f, Color? fillColor = null, Color? borderColor = null) => new Rectangle(x1, y1, x2, y2, x3, y3, x4, y4, fillColor, borderColor);
    }
}
